...
my_fig_path = file.path('figure', filename, .Platform$file.sep)
my_cache_path = file.path('_knitr_cache', filename, .Platform$file.sep)
...
```{r poly, message = FALSE, eval=TRUE, include=FALSE}
